...
class TestLogin:
    def test_login_ok(self):
        ...
        assert r.status_code in [200, 429], f"Esperaba 200 o 429 (rate limit), recibió {r.status_code}"
    ...
    def test_login_mal_password(self):
        ...
        assert r.status_code in [401, 429], f"Esperaba 401 o 429 (rate limit), recibió {r.status_code}"
